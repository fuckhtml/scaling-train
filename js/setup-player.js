(function() {
  ...
  const initSetupPlayer = () => {
    ...
    const setPlayersColor = () => {
      switch (event.target.attributes.class.value) {
        case ('setup-fireball'):
          ...
          document.querySelector('input[name="fireball-color"').value = fireballColorList[currentFireballColorIndex];
        ...
        case ('wizard-coat'): 
          ...
          document.querySelector('input[name="coat-color"').value = coatColorList[currentCoatColorIndex];
        ...
        case ('wizard-eyes'):
          ...
          document.querySelector('input[name="eyes-color"').value = eyesColorList[currentEyesColorIndex];
    ...
    document.querySelector('.setup-player').addEventListener('click', setPlayersColor, false);
  }

  document.addEventListener('DOMContentLoaded', initSetupPlayer);
